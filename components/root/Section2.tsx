        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center bg-white text-black w-[542px] h-[210px] border-1 border-b-6 border-r-4 p-[32px]">
            <div className="flex flex-col gap-y-[8px]">
                ...
                <div className="flex w-[478px] h-[36px] border-1 rounded-4xl bg-lightyellow items-center">
                    ...
                    id="stamp"
                    name="stamp"
                    className={`ml-[4px] h-[20px] input rounded-full bg-lightyellow focus:outline-none font-light`}
                    />
                </div>
            </div>
            <div>
                <button type='submit' className={`btn h-[56px] w-[161px] mt-[20px] border-b-4 border-r-2 rounded-none bg-amber-400 px-[24px] py-[16px] text-lg text-black`}>
                    SET WORD
                </button>
            </div>
        </form>
...
export function StampCardProto() {
  ...
  return (
    <div className="bg-yellow-400 p-6 rounded-2xl shadow-lg w-[300px]">
        <p>this is the stampcard proto</p>
    </div>
  );
}
...
export function HowItWorks() {
  return (
    <div className={`flex flex-col items-center bg-white text-black w-[960px] h-[580px] border-1 border-b-6 border-r-4 p-[32px]`}>
      <h2 className={`text-3xl font-bold drop-shadow-md`}>HOW IT WORKS</h2>
      <ol className={`space-y-4 text-black mt-10`}>
